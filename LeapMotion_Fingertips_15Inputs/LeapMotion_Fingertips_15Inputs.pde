// input 1 = hand x position
// input 2 = hand y position
// input 3 = hand z position
// input 4 = hand pinch
...
numFound = 0;
  for (Hand hand : leap.getHands ()) {
    ...
    if (hand.hasArm()) {
      ...
      //features[15] = (arm_wrist_pos.x - arm_elbow_pos.x);
      //features[16] = (arm_wrist_pos.y - arm_elbow_pos.y);
      //features[17] = (arm_wrist_pos.z - arm_elbow_pos.z);
    }
    ...
    for (Finger finger : hand.getFingers()) {
      ...
      case 0:
        ...
        //features[0] = finger.getDirection().x;
        //features[1] = finger.getDirection().y;
        //features[2] = finger.getDirection().z;
        break;
      case 1:
        // System.out.println("index");
                pos = finger.getPosition();
        //features[3] = finger.getDirection().x;
        //features[4] = finger.getDirection().y;
        //features[5] = finger.getDirection().z;
        break;
      case 2:
        // System.out.println("middle");
                pos = finger.getPosition();
        //features[6] = finger.getDirection().x;
        //features[7] = finger.getDirection().y;
        //features[8] = finger.getDirection().z;
        break;
      case 3:
        // System.out.println("ring");
         pos = finger.getPosition();
        //features[9] = finger.getDirection().x;
        //features[10] = finger.getDirection().y;
        //features[11] = finger.getDirection().z;
      case 4:
        // System.out.println("pinky");
         pos = finger.getPosition();
        //features[12] = finger.getDirection().x;
        //features[13] = finger.getDirection().y;
        //features[14] = finger.getDirection().z;
        break;
      }
